...
def serve(arguments):
    ...
    if arguments.ssl != None:
        print("Starting drozer Server, listening on 0.0.0.0:{} (with SSL)".format(arguments.port))
        ...
        print("Starting drozer Server, listening on 0.0.0.0:{}".format(arguments.port))
